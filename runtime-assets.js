...
(function exposeRuntimeAssets(root) {
  ...
  './app/dashboard-destination.js',
  './data.js',
  './data/season-storage.js',
  './data/running-pace-goal.js',
  './data/season-overview.js',
  './data/daybird-snapshot.js',
  './calc.js',
  './config.js',
  './ai.js',
  './ai/llm-core.js',
  ...
  './data/firebase-auth-credential.js',
  './data/firebase-auth-session.js',
  './data/data-core.js',
  './data/data-api.js',
