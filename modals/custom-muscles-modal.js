...
<div class="modal-overlay" id="custom-muscles-modal">
  <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="cmm-title">
    ...
    <div style="border-top:1px solid var(--border); margin-top:16px; padding-top:14px;">
      ...
      <div style="display:flex; gap:8px; align-items:center;">
        ...
        <button type="button" class="tds-btn fill sm" data-custom-muscle-action="add">추가</button>
      </div>
    </div>

    <div style="display:flex; gap:8px; margin-top:20px;">
      <button type="button" class="tds-btn tonal md" data-custom-muscle-action="close" style="flex:1;">닫기</button>
    </div>
  </div>
</div>
`;
