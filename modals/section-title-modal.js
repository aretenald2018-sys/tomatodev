...
<div class="modal-backdrop" id="section-title-modal" data-action="section-title:close">
...
<button class="tds-btn cancel-btn ghost md" data-action="section-title:close">취소</button>
<button class="tds-btn fill md" data-action="section-title:save">저장</button>
</div>
</div>
</div>
</div>
