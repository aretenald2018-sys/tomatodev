...
<div class="modal-backdrop" id="guild-modal" data-login-action="close-guild-modal">
  <div class="modal-sheet">
    <div class="sheet-handle"></div>
    <div class="gm-modal-header">
      <div class="modal-title tds-modal-title">소속 길드</div>
      <button class="gm-close-btn" type="button" data-login-action="close-guild-modal">닫기</button>
    </div>
    ...
    <div class="gm-section">
      ...
      <div class="gm-search-wrap">
        <input class="gm-search-input" id="gm-guild-input" placeholder="가입할 길드를 검색하세요" maxlength="20" autocomplete="off"
               data-login-input-action="search-guilds-modal" data-login-focus-action="search-guilds-modal"
               data-login-enter-action="add-guild-modal">
      ...
      <div class="gm-create-row">
        <input class="gm-search-input" id="gm-create-guild-input" placeholder="새 길드 이름" maxlength="20" autocomplete="off"
               data-login-enter-action="create-guild-modal">
        <button class="tds-btn fill md gm-create-btn" type="button" data-login-action="create-guild-modal">길드 만들기</button>
      </div>
    </div>
  </div>
</div>
